...
public class RollbackNestedScrollView extends NestedScrollView {
    ...
    public RollbackNestedScrollView(Context context) {
        super(context);
    }

    public RollbackNestedScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
